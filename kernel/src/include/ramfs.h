...
enum {
  ...
  RAMFS_INITIAL_BACKING_PAGES = 256,
...
enum ramfs_device {
  ...
  RAMFS_DEV_PROC_PID_FD,
  RAMFS_DEV_FS_ROOT,
  RAMFS_DEV_FS_BOOT,
  RAMFS_DEV_FS_RAM0,
  RAMFS_DEV_FS_TMP,
  RAMFS_DEV_SYS_CPU_POSSIBLE,
  RAMFS_DEV_SYS_CPU_PRESENT,
  RAMFS_DEV_SYS_CPU_ONLINE,
  RAMFS_DEV_SYS_CPU_CORE_ONLINE,
  RAMFS_DEV_BLK_ROOT,
  RAMFS_DEV_BLK_BOOT,
};
